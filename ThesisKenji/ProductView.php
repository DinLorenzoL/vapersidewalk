                                                ...
                                                $result = $conn->query($sql);
                                                    ...
                                                    {   
                                                        while($row = $result->fetch_assoc()){
                                                            ...
                                                            echo "<td><a href='ProductEdit.php?GetProductID=".$row["ProductID"]."'><button type='button' class='btn btn-info form-control'>Edit Product</button></td>";
                                                            echo "<td><a href='ProductDelete.php?GetProductID=".$row["ProductID"]."'><button type='button' class='btn btn-danger form-control'>Delete Product</button></td>";
                                                            echo "</tr>";
