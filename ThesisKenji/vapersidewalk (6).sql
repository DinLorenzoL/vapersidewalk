...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 27, 2019 at 01:22 PM
...
(000000000022, 'Adrian Van', 'Ladrillano', '#1F Petronia St. Buenamar Subd. Novaliches Proper', 'Quezon City', '1123', 'ivan.ladrillano@gmail.com', '0995-900-58', 'Pakikatok sa Gate', 'Blitzen RTA, ', '201', 'Approved', '2019-02-27', ''),
(000000000023, 'Adrian Van', 'Ladrillano', '#1F Petronia St. Buenamar Subd. Novaliches Proper', 'Quezon City', '1123', 'asdas@gmail.com', '0995-900-58', 'Pakikatok sa Gate', 'Serpent RDTA, Mighty Wicks, Kanger Vola 100W Mod, Creed RTA, NCR Nicotine Reinforcer RDA, Freezy Tricks, Blitzen RTA, Delorean Replacement Pods, ', '1006', 'Approved', '2019-02-22', 'Shipped to Data Center ETA Monday'),
(000000000024, 'Adrian', 'Ladrillano', 'Novaliches', 'Quezon City', '1123', 'ivan.ladrillano@gmail.com', '9959005870', 'Pakikatok sa Gate', 'Muji Cotton Pad, Mighty Wicks, Mighty Wicks, Mighty Wicks, ', '810', 'Pending', '0000-00-00', '');
...
(000000000020, 'Delorean Replacement Pods', 'Accessories', 200, -1, 'Durable. Flavor-accurate. Designed for both high and low power vaping.', 'Delorean refillable pods utilize a ceramic wick and coil system for durability and flavor- accuracy. The coils are designed to work with liquids as high as 60% VG, though Nikolas recommendation is still primarily 50% VG liquids for optimal performance.\n\nDelorean is designed to work on multiple voltage levels, allowing higher power for thicker, freebase nic liquids and lower power for thinner, salt nic liquids. Please consult the manual and know your liquids characteristics for the appropriate setting, or consult Mistwood.', 'pods.png', '2.0ml Juice Capacity - PCTG Refillable Pod', 'Resistance: 1.2ohm', 'Double protection against leaks', 'Porous ceramic wick', 'High to low power compatible'),
(000000000021, 'Muji Cotton Pad', 'Accessories', 10, 0, 'Muji cotton pads allow for easy cutting and forming into wicks for use in rebuildable atomizers. Made from 100% unbleached Japanese cotton, it ensures the purest vapor flavor possible with cotton wicking.', '', 'cotton2.png', '', '', '', '', ''),
(000000000022, 'Mighty Wicks', 'Accessories', 200, 95, 'Organic cotton pre-fluffed by machine for very high wicking rate and optimal flavor.', '', 'cotton1.png', '', '', '', '', ''),
...
(000000000025, 'Freezy Tricks', 'Juice', 400, 98, 'Enjoy a blast of freshness in our year-round heat.', 'Strong menthol with delectable fruit combinations bring you the freshness that you are craving. Perfect for our year-round summer.', 'juice3.png', 'Volume: 60 mL/bottle', 'Nicotine levels: 3mg/mL', 'VG to PG ratio: 60:40', 'Pod Compatibility: Yes', ''),
...
--
ALTER TABLE `orders`
  MODIFY `OrderID` float UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
--
