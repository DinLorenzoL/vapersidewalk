                            ...
                            <div class="card-body">
                                <div class="col-lg-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <label> Price </label>
                                                <input type="text" class="form-control" name="PriceTxt">
                                            </div>

                                            <div class="col-md-6">
                                                <label> Quantity </label>
                                                <input type="number" class="form-control" name="QuanTxt">
                                            </div>
                                        </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4 text-center">
                                        ...
                                        <img id="preview" style="width: 550px;height: 550px;" />
                                        <input type="file" name="fileToUpload" onchange="loadFile1(event)">
                                    </div>

                                    <div class="col-md-8">
                                        <div class="col-md-6">
                                            <label> Feature 1 </label>
                                            <input type="text" class="form-control" name="F1Txt">
                                        </div>

                                        <div class="col-md-6">
                                            <label> Feature 2 </label>
                                            <input type="text" class="form-control" name="F2Txt">
                                        </div>
                                        <div class="col-md-6">
                                            <label> Feature 3 </label>
                                            <input type="text" class="form-control" name="F3Txt">
                                        </div>

                                        <div class="col-md-6">
                                            <label> Feature 4 </label>
                                            <input type="text" class="form-control" name="F4Txt">
                                        </div>
                                        <div class="col-md-6">
                                            <label> Feature 5 </label>
                                            <input type="text" class="form-control" name="F5Txt">
                                        </div>

                                        <div class="col-md-12">
                                            <label>Short Description</label>
                                            <textarea class="form-control" rows="4" name="ShortTxt"></textarea>
                                        </div>
                                        <div class="col-md-12">
                                            <label>Long Description</label>
                                            <textarea class="form-control" rows="8" name="LongTxt"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        if(in_array($fileActualExt, $allowed)){
            if($fileError === 0){
                if($fileSize < 10000000){
                    ...
                    include("SQL.php");
                    $query = "INSERT INTO product(ProductID, Name, Category, Price, Quantity, ShortD, LongD, Feature1, Feature2, Feature3, Feature4, Feature5, Image) 
                    VALUES('','" .$Name. "', '" .$Category. "', '" .$Price. "', '" .$Quantity. "', '" .$ShortD. "', '" .$LongD. "', '".$Feature1. "', '".$Feature2. "', '".$Feature3. "', '".$Feature4. "', '".$Feature5. "', '" .$fileName."')";
                        if($conn->query($query) == TRUE){

                                    
                            echo "<script> alert('Successfully added'); </script>";
                            echo "<script> location.href='productentry.php>";
                        }
                        else{
