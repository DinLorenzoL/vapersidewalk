...
<body>
    ...
    <div id="right-panel" class="right-panel">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                               ...
                                               <tbody>
                                                <?php
                                                include("SQL.php");
                                                $sql = "SELECT * FROM `orders` WHERE `OrderID` = '$GetID'";
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <label>Orders</label>
                                                    <textarea class="form-control"><?php echo $Items; ?></textarea>
                                                </div>
                                            </div>
                                            <br>
                                            <div class="row">
        ...
        <option value="Cancelled" <?php if ($OrderStatus === "Cancelled") echo 'selected'; ?>>Cancelled</option>
                                                ...
                                                <div class="col-md-6">
                                                    <label>&nbsp</label>
                                                    <input type="submit" name="formSubmit" class="btn btn-block btn-primary">
                                                </div>
                                            </div>
                                       </div>
                                    </div>
...
include("SQL.php");
$FinalID = $_POST['GetID2'];
$GetUpdate = $_POST['UpdateMe'];

$sql = "UPDATE `orders` SET OrderStatus='" . $GetUpdate . "' WHERE `OrderID` =".$FinalID;
      ...
      if($result)
      {
           ...
           echo "<script> location.href='view_order.php?GetOrderID=$FinalID' </script>";
      }else{
