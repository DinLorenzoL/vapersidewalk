...
<html>
   ...
   <body>
      ...
      <div id="page">
		...
		<form action="addtocart.php" method="GET" class="colorlib-form">
               ...
               <div class="row row-pb-md">
                     ...
                     <div class="product-cart">
                        <div class="one-forth" style="">
                           <div class="display-tc">
                              <h3><?php echo ' Select Atomizer'; ?></h3>
                           </div>
                        </div>
                        <div class="one-eight text-center">
                           <div class="display-tc">
                              <span class="price">
                              <select class="form-control" name = "atomizerselect" style="width: 500px;">
                              <?php 
                                 include("SQL.php");
                                 $TotalAtomizer = 0;
                                 			$sql = "SELECT * FROM product WHERE Category = 'Atomizer' AND Quantity > 0";
                                 			$result = $conn->query($sql);
                                 				if($result->num_rows > 0)
                                 				{                   
                                 					while($row = $result->fetch_assoc()){ 	
                                 					$TotalAtomizer = $TotalAtomizer + $row['Price'];
                  ...
                  <div class="col-md-10 col-md-offset-1">
                     ...
                     <div class="product-cart">
                        <div class="one-forth">
                           <div class="display-tc">
                              <h3><?php echo ' Select Batteries'; ?></h3>
                           </div>
                        </div>
                        <div class="one-eight text-center">
                           <div class="display-tc">
                              <span class="price">
                              <select class=form-control name = "batteriesselect" style="width: 500px;">
                              <?php 
                                 include("SQL.php");
                                 $TotalAtomizer = 0;
                                 			$sql = "SELECT * FROM product WHERE Category = 'Batteries' AND Quantity > 0";
                                 			$result = $conn->query($sql);
                                 				if($result->num_rows > 0)
                                 				{                   
                                 					while($row = $result->fetch_assoc()){ 	
                  ...
                  <div class="col-md-10 col-md-offset-1">
                     ...
                     <div class="product-cart">
                        <div class="one-forth">
                           <div class="display-tc">
                              <h3><?php echo ' Select Mods'; ?></h3>
                           </div>
                        </div>
                        <div class="one-eight text-center">
                           <div class="display-tc">
                              <span class="price">
                              <select class=form-control name = "modsselect" style="width: 500px;">
                              <?php 
                                 include("SQL.php");
                                 $TotalAtomizer = 0;
                                 			$sql = "SELECT * FROM product WHERE Category = 'Mods' AND Quantity > 0";
                                 			$result = $conn->query($sql);
                                 				if($result->num_rows > 0)
                                 				{                   
                                 					while($row = $result->fetch_assoc()){ 	
               ...
               <div class="total-wrap">
                  <div class="row">
                     <div class="col-md-12 text-center">
                        <button type="submit" class="btn btn-primary btn-block">Add to cart!</button></a>
                     </div>
                  </div>
               </div>
            </div>
